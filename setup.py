...
setup(
    ...
    description="Creates a resource pack for Minecraft from a BDF type file",  # Optional
    ...
    url="https://github.com/takejohn/BDF2MCPack",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Take-John",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="105504345+takejohn@users.noreply.github.com",  # Optional
    ...
    keywords="minecraft bdf",  # Optional
    ...
    install_requires=['bdfparser', 'pillow', 'tqdm'],  # Optional
